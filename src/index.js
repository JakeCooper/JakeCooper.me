...
const accolades = () => {
  ...
  return allAccolades.map(
    accolade => `Once, I ${TypedElement(accolade)} ^2000`
  );
};
...
const home = () => (
  <div className={styles.content}>
    <div className={styles.leftContent}>
      <h1 className={styles.intro}>Hey, I'm Jake</h1>
  ...
  <div>
    ...
    <div className={styles.lower}>
      <div className={styles.socialbar}>
        <a
          href="https://twitter.com/RealJakeCooper"
          target="_blank"
          className={styles.twitter}
        ></a>
        <a
          href="https://facebook.com/JakeElijahCooper"
          target="_blank"
          className={styles.facebook}
        ></a>
        <a href="mailto:Jake@JakeCooper.me" className={styles.email}></a>
        <a
          href="https://www.linkedin.com/in/thejakecooper/"
          target="_blank"
          className={styles.linkedin}
        ></a>
        <a
          href="https://github.com/jakecooper"
          target="_blank"
          className={styles.github}
        ></a>
      </div>
      <div className={styles.footer}>Made with 🍁 in Canada</div>
    </div>
  </div>
);
